      ...
      <div className="max-w-7xl mt-24 mx-auto items-center flex flex-col md:flex-row gap-16 md:gap-40 justify-between">
        <div className="md:space-y-6 px-4">
          <h1 className="md:text-6xl text-4xl font-bold mb-4">
            Hi👋, I'm <p className="text-blue-400">Amit Pundir</p>
          </h1>
          ...
          <button className="px-3 py-2 flex items-center gap-2 bg-blue-500 rounded-md text-white hover:bg-blue-600 shadow-blue-500 border-2 border-blue-400 transition-all shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#33CCCC,0_0_15px_#33CCCC,0_0_30px_#33CCCC]">
            <a
              href="/Amit_Pundir_Resume.pdf"
              download="Amit_Pundir_Resume.pdf"
              className="px-2 py-1.5 flex items-center gap-1 bg-blue-500 rounded-md text-white hover:bg-blue-600 shadow-blue-500 border-2 border-blue-400 transition-all shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#33CCCC,0_0_15px_#33CCCC,0_0_30px_#33CCCC]"
            >
          ...
          <div className="flex gap-3 text-2xl transition-all mt-5 md:mt-0">
            <a href="https://www.linkedin.com/in/amitpundir01/" target="_blank">
